...
/**
 * Entity representing the main Quarry Lease Application.
 */
@Entity
@Table(name = "t_quarry_lease_application")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class QuarryLeaseApplication {
    ...
    @Column(name = "mla_signed_doc_id", length = 100)
